...
public class SellingFragment extends TempleBaseFragment {
    @Override
    protected int getContentViewId() {
        return R.layout.fragment_seller_selling;
    }
    ...
    protected void initView(View rootView) {
        ...
        mAdapter = new ShopAdapter(getActivity(), 1);
    ...
    private void initData(final Boolean refresh) {
        ...
        sellerRdm.getShopList(ConstantS.BASE_URL + "sample/getSellerSampleList.htm", mPage, 1);
                ...
                if (pageList != null) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (mOrderLists.isEmpty() && refresh) {
