...
public class WithdrawalDetailActivity extends TempBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(mTranslatesString.getAssets_withdraw());
    ...
    private void initData(final Boolean refresh) {
        ...
        sellerRdm.getWithdrawList(ConstantS.BASE_URL + "withdraw/list.htm", mPage, 1);
